@extends('layouts.app', ['sitio' => 'entregados'])
@section('content')
        ...
        <div class="col">
            <div class="card shadow" style="padding: 10px;">
                <div class="card-header bg-transparent border-0">
                    <h3 class="text-black mb-0">Productos Entregados: </h3>
                </div>
                <div>
...
<script>
    $(document).ready(function() {
        ...
        //datos
        "ajax": {
            "url": "{{ route('personas.get-data-all-entregados') }}",
            "data": {
                "_token": "{{ csrf_token() }}",
            },
            "dataType": "json",
                ...
                "render": function(data, type, row, meta) {
                     ...
                     if(row.status == 'ENTREGADO'){
                        return '<button value="' + row.id +
                            '" type="button" title="Ver detalle de la entrega" id="btn-detalle" class="btn btn-success"><i class="fas fa-american-sign-language-interpreting"></i></button>' +
